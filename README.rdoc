...
Because the relationship with Roify is polymorphic, we could be displaying any type of object that can be modeled.  To get around this RolifyUI will guess what the display label is.

Here is the order, to specify the display name just define an instance method on the object called 'rolified_name'.
